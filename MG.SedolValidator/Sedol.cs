...
namespace MG.SedolValidator
{
    public sealed class Sedol
    {
        ...
        private bool IsValid(out string validationDetails, out bool skipIsUserDefinedValidation)
        {
            ...
            {
                if (SedolConstants.ValidCharacters.IndexOf(c) < 0)
                {
        ...
        private char GetChecksumDigitChar()
        {
            ...
            for (int i = 0; i < valuePart1.Length; i++)
            {
                ...
                else m = SedolConstants.ValidCharacters.IndexOf(c); // char index
    ...
    public class SedolConstants
    {
        ...
        public const string ValidCharacters = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
